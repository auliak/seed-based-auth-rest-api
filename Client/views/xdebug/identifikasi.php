...
<script type="text/javascript">
	...
	{
		$.ajax({
			url: 'http://192.168.182.136/authenticationserver/authenticater/web/index.php/auth/identifikasi/<?php echo $url_token;?>/<?php echo $unm_token;?>/<?php echo $seq_num;?>'+'?XDEBUG_PROFILE=1',
			type: 'POST',
			dataType: 'json',
